 ...
 */
class ExternalMappingController extends BaseController {

    /**
     * @var ExternalMappingController The reference to *Singleton* instance of this class
     */
    private static $instance;
    
    /**
     * Returns the *Singleton* instance of this class.
     * @return ExternalMappingController The *Singleton* instance.
     */
     ...
     * @param  Models\ExternalMapping $data      Optional parameter: An object of model property name/value pairs
                ...
                $data = NULL) 
    {
        ...
        $_queryBuilder = $_queryBuilder.'/external-mappings/update';
     ...
     * @throws APIException Thrown if API call fails
     */
    public function updateExternalMappingupdateAttributes (
                $id,
                $data = NULL) 
    {
        //the base uri for api requests
        ...
        //prepare query string for API call
        $_queryBuilder = $_queryBuilder.'/external-mappings/{id}';
     ...
     * @param  Models\ExternalMapping $data     Optional parameter: Model instance data
     * @return mixed response from the API call
     * @throws APIException Thrown if API call fails
     */
                ...
                $data = NULL) 
    {
        ...
        //prepare query string for API call
        $_queryBuilder = $_queryBuilder.'/external-mappings/';
                ...
                $id) 
    {
        ...
        //prepare query string for API call
        $_queryBuilder = $_queryBuilder.'/external-mappings/location/{id}';
     ...
     * @throws APIException Thrown if API call fails
     */
    public function getAccommodationMapping (
                $id) 
    {
        //the base uri for api requests
        $_queryBuilder = Configuration::$BASEURI;
        ...
        //prepare query string for API call
        $_queryBuilder = $_queryBuilder.'/external-mappings/accommodation/{id}';
                ...
                $where = NULL) 
    {
        ...
        //prepare query string for API call
        $_queryBuilder = $_queryBuilder.'/external-mappings/count';
                ...
                $filter = NULL) 
    {
        ...
        //prepare query string for API call
        $_queryBuilder = $_queryBuilder.'/external-mappings/findOne';
     ...
     * @throws APIException Thrown if API call fails
     */
    public function getExistsGetExternalMappingsIdExists (
                $id) 
    {
        //the base uri for api requests
        $_queryBuilder = Configuration::$BASEURI;
        ...
        //prepare query string for API call
        $_queryBuilder = $_queryBuilder.'/external-mappings/{id}/exists';
        ...
        return $mapper->map($response->body, new Models\ExistsGetExternalMappingsIdExistsResponse());
    }
