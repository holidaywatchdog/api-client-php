...
class UserPhotoController extends BaseController {
    ...
    /**
     * @var UserPhotoController The reference to *Singleton* instance of this class
     */
    private static $instance;
    
    /**
     * Returns the *Singleton* instance of this class.
     * @return UserPhotoController The *Singleton* instance.
     */
     ...
     * @param  Models\UserPhoto $data      Optional parameter: An object of model property name/value pairs
                ...
                $data = NULL) 
    {
        ...
        $_queryBuilder = $_queryBuilder.'/user-photos/update';
     ...
     * @throws APIException Thrown if API call fails
     */
    public function updateUserPhotoupdateAttributes (
                $id,
                $data = NULL) 
    {
        //the base uri for api requests
        ...
        //prepare query string for API call
        $_queryBuilder = $_queryBuilder.'/user-photos/{id}';
     ...
     * @param  Models\UserPhoto $data     Optional parameter: Model instance data
     * @return mixed response from the API call
     * @throws APIException Thrown if API call fails
     */
                ...
                $data = NULL) 
    {
        ...
        //prepare query string for API call
        $_queryBuilder = $_queryBuilder.'/user-photos/';
                ...
                $where = NULL) 
    {
        ...
        //prepare query string for API call
        $_queryBuilder = $_queryBuilder.'/user-photos/count';
                ...
                $filter = NULL) 
    {
        ...
        //prepare query string for API call
        $_queryBuilder = $_queryBuilder.'/user-photos/findOne';
     ...
     * @throws APIException Thrown if API call fails
     */
    public function getExistsGetUserPhotosIdExists (
                $id) 
    {
        //the base uri for api requests
        $_queryBuilder = Configuration::$BASEURI;
        ...
        //prepare query string for API call
        $_queryBuilder = $_queryBuilder.'/user-photos/{id}/exists';
        ...
        return $mapper->map($response->body, new Models\ExistsGetUserPhotosIdExistsResponse());
    }
     ...
     * @throws APIException Thrown if API call fails
     */
    public function getUserPhotoGetUserPhotoAlbum (
                $id,
                $refresh = NULL) 
    {
        //the base uri for api requests
        ...
        //prepare query string for API call
        $_queryBuilder = $_queryBuilder.'/user-photos/{id}/user-photo-album';
