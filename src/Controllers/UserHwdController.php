 ...
 */
class UserHwdController extends BaseController {

    /**
     * @var UserHwdController The reference to *Singleton* instance of this class
     */
    private static $instance;
    
    /**
     * Returns the *Singleton* instance of this class.
     * @return UserHwdController The *Singleton* instance.
     */
     ...
     * @param  Models\UserHwd $data     Optional parameter: Model instance data
                ...
                $data = NULL) 
    {
        ...
        $_queryBuilder = $_queryBuilder.'/user-hwds/';
                ...
                $filter = NULL) 
    {
        ...
        return $mapper->mapArray($response->body, array(), new Models\UserHwd());
    }
                ...
                $where = NULL) 
    {
        ...
        //prepare query string for API call
        $_queryBuilder = $_queryBuilder.'/user-hwds/count';
                ...
                $filter = NULL) 
    {
        ...
        //prepare query string for API call
        $_queryBuilder = $_queryBuilder.'/user-hwds/findOne';
                ...
                $id) 
    {
        ...
        //prepare query string for API call
        $_queryBuilder = $_queryBuilder.'/user-hwds/{id}';
     ...
     * @throws APIException Thrown if API call fails
     */
    public function getExistsGetUserHwdsIdExists (
                $id) 
    {
        //the base uri for api requests
        $_queryBuilder = Configuration::$BASEURI;
        ...
        //prepare query string for API call
        $_queryBuilder = $_queryBuilder.'/user-hwds/{id}/exists';
        ...
        return $mapper->map($response->body, new Models\ExistsGetUserHwdsIdExistsResponse());
    }
     ...
     * @throws APIException Thrown if API call fails
     */
    public function deleteUserHwdDeleteUserPhotoAlbums (
                $id) 
    {
        //the base uri for api requests
        $_queryBuilder = Configuration::$BASEURI;
        ...
        //prepare query string for API call
        $_queryBuilder = $_queryBuilder.'/user-hwds/{id}/user-photo-albums';
     ...
     * @throws APIException Thrown if API call fails
     */
    public function createUserHwdCreateUserPhotoAlbums (
                $id,
                $data = NULL) 
    {
        //the base uri for api requests
     ...
     * @throws APIException Thrown if API call fails
     */
    public function getUserHwdGetUserPhotoAlbums (
                $id,
                $filter = NULL) 
    {
        //the base uri for api requests
     ...
     * @throws APIException Thrown if API call fails
     */
    public function deleteUserHwdDeleteUserReviews (
                $id) 
    {
        //the base uri for api requests
        $_queryBuilder = Configuration::$BASEURI;
        ...
        //prepare query string for API call
        $_queryBuilder = $_queryBuilder.'/user-hwds/{id}/user-reviews';
     ...
     * @throws APIException Thrown if API call fails
     */
    public function createUserHwdCreateUserReviews (
                $id,
                $data = NULL) 
    {
        //the base uri for api requests
     ...
     * @throws APIException Thrown if API call fails
     */
    public function getUserHwdGetUserReviews (
                $id,
                $filter = NULL) 
    {
        //the base uri for api requests
     ...
     * @throws APIException Thrown if API call fails
     */
    public function deleteUserHwdDestroyByIdUserReviews (
                $fk,
                $id) 
    {
        //the base uri for api requests
        ...
        //prepare query string for API call
        $_queryBuilder = $_queryBuilder.'/user-hwds/{id}/user-reviews/{fk}';
     ...
     * @throws APIException Thrown if API call fails
     */
    public function getUserHwdFindByIdUserReviews (
                $fk,
                $id) 
    {
        //the base uri for api requests
     ...
     * @throws APIException Thrown if API call fails
     */
    public function updateUserHwdUpdateByIdUserReviews (
                $fk,
                $id,
                $data = NULL) 
    {
     ...
     * @throws APIException Thrown if API call fails
     */
    public function getUserHwdFindByIdUserPhotoAlbums (
                $fk,
                $id) 
    {
        //the base uri for api requests
        ...
        //prepare query string for API call
        $_queryBuilder = $_queryBuilder.'/user-hwds/{id}/user-photo-albums/{fk}';
     ...
     * @throws APIException Thrown if API call fails
     */
    public function updateUserHwdUpdateByIdUserPhotoAlbums (
                $fk,
                $id,
                $data = NULL) 
    {
     ...
     * @throws APIException Thrown if API call fails
     */
    public function deleteUserHwdDestroyByIdUserPhotoAlbums (
                $fk,
                $id) 
    {
        //the base uri for api requests
     ...
     * @throws APIException Thrown if API call fails
     */
    public function getUserHwdCountUserReviews (
                $id,
                $where = NULL) 
    {
        //the base uri for api requests
        ...
        //prepare query string for API call
        $_queryBuilder = $_queryBuilder.'/user-hwds/{id}/user-reviews/count';
        ...
        return $mapper->map($response->body, new Models\UserHwdCountUserReviewsResponse());
    }
     ...
     * @throws APIException Thrown if API call fails
     */
    public function getUserHwdCountUserPhotoAlbums (
                $id,
                $where = NULL) 
    {
        //the base uri for api requests
        ...
        //prepare query string for API call
        $_queryBuilder = $_queryBuilder.'/user-hwds/{id}/user-photo-albums/count';
        ...
        return $mapper->map($response->body, new Models\UserHwdCountUserPhotoAlbumsResponse());
    }
        
    /**
     * Update attributes for a model instance and persist it into the data source.
     * @param  string      $id       Required parameter: PersistedModel id
     * @param  Models\UserHwd $data     Optional parameter: An object of model property name/value pairs
     * @return mixed response from the API call
     * @throws APIException Thrown if API call fails
     */
    public function updateUserHwdupdateAttributes (
                $id,
                $data = NULL) 
    {
        //the base uri for api requests
                ...
                $where = NULL) 
    {
        ...
        //prepare query string for API call
        $_queryBuilder = $_queryBuilder.'/user-hwds/update';
