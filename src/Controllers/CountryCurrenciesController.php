 ...
 */
class CountryCurrenciesController extends BaseController {

    /**
     * @var CountryCurrenciesController The reference to *Singleton* instance of this class
     */
    private static $instance;
    
    /**
     * Returns the *Singleton* instance of this class.
     * @return CountryCurrenciesController The *Singleton* instance.
     */
     ...
     * @param  Models\CountryCurrencies $data      Optional parameter: An object of model property name/value pairs
                ...
                $data = NULL) 
    {
        ...
        $_queryBuilder = $_queryBuilder.'/country-currencies/update';
     ...
     * @throws APIException Thrown if API call fails
     */
    public function updateCountryCurrenciesupdateAttributes (
                $id,
                $data = NULL) 
    {
        //the base uri for api requests
        ...
        return $mapper->map($response->body, new Models\CountryCurrencies());
    }
        
    /**
     * Create a new instance of the model and persist it into the data source.
     * @param  Models\CountryCurrencies $data     Optional parameter: Model instance data
     * @return mixed response from the API call
     * @throws APIException Thrown if API call fails
     */
                ...
                $data = NULL) 
    {
        ...
        //prepare query string for API call
        $_queryBuilder = $_queryBuilder.'/country-currencies/';
                ...
                $filter = NULL) 
    {
        ...
        return $mapper->mapArray($response->body, array(), new Models\CountryCurrencies());
    }
                ...
                $where = NULL) 
    {
        ...
        //prepare query string for API call
        $_queryBuilder = $_queryBuilder.'/country-currencies/count';
                ...
                $filter = NULL) 
    {
        ...
        //prepare query string for API call
        $_queryBuilder = $_queryBuilder.'/country-currencies/findOne';
     ...
     * @throws APIException Thrown if API call fails
     */
    public function getExistsGetCountryCurrenciesIdExists (
                $id) 
    {
        //the base uri for api requests
        $_queryBuilder = Configuration::$BASEURI;
        ...
        return $mapper->map($response->body, new Models\ExistsGetCountryCurrenciesIdExistsResponse());
    }
