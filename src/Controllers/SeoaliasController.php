 ...
 */
class SeoaliasController extends BaseController {

    /**
     * @var SeoaliasController The reference to *Singleton* instance of this class
     */
    private static $instance;
    
    /**
     * Returns the *Singleton* instance of this class.
     * @return SeoaliasController The *Singleton* instance.
     */
     ...
     * @param  Models\Seoalias $data      Optional parameter: An object of model property name/value pairs
                ...
                $data = NULL) 
    {
        ...
        $_queryBuilder = $_queryBuilder.'/seoaliases/update';
     ...
     * @param  Models\Seoalias $data     Optional parameter: Model instance data
     * @return mixed response from the API call
     * @throws APIException Thrown if API call fails
     */
                ...
                $data = NULL) 
    {
        ...
        //prepare query string for API call
        $_queryBuilder = $_queryBuilder.'/seoaliases/';
        ...
        return $mapper->map($response->body, new Models\Seoalias());
    }
     ...
     * @throws APIException Thrown if API call fails
     */
    public function updateSeoaliasupdateAttributes (
                $id,
                $data = NULL) 
    {
        //the base uri for api requests
        ...
        //prepare query string for API call
        $_queryBuilder = $_queryBuilder.'/seoaliases/{id}';
                ...
                $filter = NULL) 
    {
        ...
        return $mapper->mapArray($response->body, array(), new Models\Seoalias());
    }
                ...
                $where = NULL) 
    {
        ...
        //prepare query string for API call
        $_queryBuilder = $_queryBuilder.'/seoaliases/count';
                ...
                $filter = NULL) 
    {
        ...
        //prepare query string for API call
        $_queryBuilder = $_queryBuilder.'/seoaliases/findOne';
     ...
     * @throws APIException Thrown if API call fails
     */
    public function getExistsGetSeoaliasesIdExists (
                $id) 
    {
        //the base uri for api requests
        $_queryBuilder = Configuration::$BASEURI;
        ...
        //prepare query string for API call
        $_queryBuilder = $_queryBuilder.'/seoaliases/{id}/exists';
        ...
        return $mapper->map($response->body, new Models\ExistsGetSeoaliasesIdExistsResponse());
    }
